...
Const
  ...
  NoApacheOSes        = [amiga,aros,morphos,wasip1,wasip1threads,ohos];
...
begin
  With Installer do
    ...
    P.Version:='3.3.1';
    P.OSes := [beos,haiku,freebsd,darwin,iphonesim,ios,solaris,netbsd,openbsd,linux,win32,win64,wince,aix,amiga,aros,morphos,dragonfly,android,ohos,wasip1,wasip1threads];
